...
|HLA00019|SuT has SOM|SuT shall update attribute values for each published object class attribute according to update type and condition defined in CS SOM.	|Object Management||
...
|SuT|SuT SOM|SOM file ref.|Required. Documentation of publication and subscription declaration.|
|SuT|SuT HLA Service Calls|list|Optional. List of all HLA RTI Ambassador Services used.|
|SuT|SuT HLA Service Callbacks|list|Optional. List of all implemented HLA Federate Ambassador Services.|
